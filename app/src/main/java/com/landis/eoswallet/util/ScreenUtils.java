...
public class ScreenUtils {
    ...
    public static int dpToPx(Context c, int dp) {
        DisplayMetrics metrics = getDisplayMetrics(c);
     ...
     * @return
     */
    public static int[] getAppSize(Context c) {
        int[] size = new int[2];
        DisplayMetrics metrics = getDisplayMetrics(c);
     ...
     * @return
     */
    private static boolean hasNavigationBar(Context c) {

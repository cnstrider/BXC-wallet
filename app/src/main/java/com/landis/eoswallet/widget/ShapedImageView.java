package com.landis.eoswallet.widget;
        ...
        if (changed) {
            ...
            if (mShape == null) {
                ...
                if (mShapeMode == SHAPE_MODE_ROUND_RECT) {
                    ...
                    radius = new float[]{mRadius, mRadius, mRadius, mRadius, 0f, 0f, 0f, 0f};
                } else if (mShapeMode == 4) {
                    radius = new float[]{0f, 0f, 0f, 0f, mRadius, mRadius, mRadius, mRadius};
                }
